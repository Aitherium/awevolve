"""Stack-aware `doctor` for awevolve.
...
interesting failures live BETWEEN them. "awevolve is installed" is not the useful
fact -- "awevolve is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awevolve'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['adk', 'awgit', 'awm', 'awpredict', 'awrun']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awevolve needs at runtime, and a
